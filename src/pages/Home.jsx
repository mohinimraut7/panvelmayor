...
// import heroBg from "../assets/nitinpatilsir.jpeg";
...
//   const projects = [
//     { icon: "🌉", tag: "पायाभूत सुविधा", title: "नारंगी उड्डाणपूल प्रकल्प पाहणी", desc: "नारंगी येथील उड्डाणपुलाच्या कामाची मा. महापौर श्री.नितीन पाटील यांनी प्रत्यक्ष पाहणी केली. या पाहणीदरम्यान संबंधित अधिकारी, रेल्वे अधिकारी, कंत्राटदार व उपकंत्राटदार यांच्याशी चर्चा करून कामाची प्रगती व अडचणी जाणून घेतल्या. तसेच कामाला अधिक गती देण्याच्या सूचना दिल्या.", progress:'', status: "ongoing", statusLabel: "सुरू आहे", budget: "₹ 42 कोटी", deadline: "डिसेंबर 2025", stat: "", statLbl: "मार्च २०२६ अखेर वाहतुकीसाठी खुले", accent: "#51ABAC", bgimg: carousel1 },
...
//         :root {
//   --teal: #9095C4;   /* ← was #51ABAC */
//   --green: #6b72b0;  /* ← was #028945 */
//   --gold: #F5E6BF;
//   --blue: #4CABBF;
// }
...
//         .hiw-icon-wrap { width:72px; height:72px; border-radius:50%;   background: linear-gradient(135deg, #9095C4, #6b72b0);
//   box-shadow: 0 16px 40px rgba(144,149,196,0.22), 0 4px 12px rgba(0,0,0,0.06); display:flex; align-items:center; justify-content:center; margin:0 auto 20px;); flex-shrink:0; }
//         .hiw-num { position:absolute; top:14px; right:16px; width:26px; height:26px; border-radius:50%;  background: linear-gradient(135deg, #9095C4, #6b72b0);,var(--green)); color:#fff; font-size:11px; font-weight:800; font-family:'DM Sans',sans-serif; display:flex; align-items:center; justify-content:center; }
...
//         .mayor-right {
//           flex: 1;
//            background: linear-gradient(145deg, #5a5f9a 0%, #3d4280 40%, #272b5e 100%);
//           position: relative;
//           overflow: hidden;
//           display: flex;
//           align-items: center;
...
//           height: 3px;
//           background: linear-gradient(90deg, transparent, #9095C4 20%, #b8bbdc 60%, transparent 100%);
//           z-index: 4;
//         }
...
//           border-radius: 50%;
//          background: radial-gradient(circle, rgba(144,149,196,0.18) 0%, transparent 65%);
...
//          border: 1.5px solid rgba(144,149,196,0.35);
//           display: flex;
//           align-items: center;
//           justify-content: center;
//           box-shadow: 0 6px 18px rgba(144,149,196,0.2), inset 0 1px 0 rgba(255,255,255,0.12);
...
//           position: relative;
//           box-shadow:
//            0 0 0 2px rgba(144,149,196,0.6),
//     0 0 0 5px rgba(144,149,196,0.15),
...
//     { icon: "💧", tag: "पाणीपुरवठा", title: "24×7 पाणीपुरवठा योजना — वसई विभाग", desc: "पनवेल विभागातील नागरिकांना 24 तास शुद्ध पाणी उपलब्ध करण्यासाठी नवीन जलवाहिन्या टाकणे, जुन्या पाइपलाइनचे नूतनीकरण आणि नवीन पाण्याच्या टाक्या बांधणे.", progress: '', status: "ongoing", statusLabel: "सुरू आहे", budget: "₹ 85 कोटी", deadline: "मार्च 2026", stat: "1.2 लाख", statLbl: "लाभार्थी कुटुंबे", accent: "#6b72b0", bgimg: pani },
...
//       date: "२८ फेब्रुवारी २०२६",
//       accent: "#9095C4",
//       bg: "linear-gradient(160deg,#d4d6ee 0%,#e8e9f7 40%,#c8caec 100%)",
//       dotColors: ["#9095C4", "#6b72b0"],
//     },
//     {
//       tag: "🧹 स्वच्छता आढावा",
//       title: "दैनंदिन कचरा संकलन व स्वच्छता बैठक",
...
//       date: "११ मार्च २०२६",
//       accent: "#6b72b0",
//       bg: "linear-gradient(160deg,#c4c7e0 0%,#d8daee 40%,#b8bcd8 100%)",
//       dotColors: ["#6b72b0", "#CA9D28"],
//     },
//     {
//       tag: "🛣️ रस्ते विकास",
//       title: "रस्ते दुरुस्ती व पायाभूत सुविधा नियोजन बैठक",
...
//       date: "५ मार्च २०२६",
//       accent: "#9095C4",
//       bg: "linear-gradient(160deg,#d4d6ee 0%,#e4e6f5 40%,#c0c4e8 100%)",
//       dotColors: ["#9095C4", "#6b72b0"],
//     },
//   ];
...
//         .hero { position:relative; min-height:calc(100vh - 64px); display:flex; flex-direction:column; align-items:center; justify-content:center; text-align:center; padding:80px 24px 72px; overflow:hidden; }
//         .hero::before { content:''; position:absolute; inset:0; background-image:url(${heroBg}); background-size:cover; background-position:left; background-repeat:no-repeat; z-index:0; }
//         .hero::after { content:''; position:absolute; inset:0; background:rgba(39,43,94,0.78); z-index:1; }
//         .hero > * { position:relative; z-index:2; }
//         .hero-orbit { position:absolute; inset:0; z-index:2; pointer-events:none; }
//         .hero-float { position:absolute; background:rgba(144,149,196,0.92); border-radius:50%; display:flex; align-items:center; justify-content:center; font-size:18px; box-shadow:0 4px 20px rgba(0,0,0,0.25); animation:floatBob 3s ease-in-out infinite; }
//         .hero-float.f1{width:52px;height:52px;top:28%;left:8%;animation-delay:0s}
//         .hero-float.f2{width:44px;height:44px;top:60%;left:16%;animation-delay:0.7s}
//         .hero-float.f3{width:52px;height:52px;top:22%;right:8%;animation-delay:1.1s}
//         .hero-float.f4{width:44px;height:44px;top:58%;right:14%;animation-delay:0.4s}
//         @keyframes floatBob{0%,100%{transform:translateY(0)}50%{transform:translateY(-10px)}}
//         .hero-jansanwad { font-family:'Tiro Devanagari Marathi',serif; font-size:clamp(52px,10vw,96px); font-weight:800; color:#F5D87A; line-height:1.05; margin-bottom:18px; text-shadow:0 4px 32px rgba(0,0,0,0.3),0 2px 8px rgba(0,0,0,0.2); letter-spacing:-1px; }
//         .hero-title-underline { width:80px; height:4px; background:linear-gradient(90deg,#9095C4,#b8bbdc,#9095C4); border-radius:2px; margin:0 auto 22px; animation:shimmer 2.5s ease-in-out infinite; }
//         @keyframes shimmer{0%,100%{opacity:1}50%{opacity:0.6}}
//         .hero-desc { font-family:'Tiro Devanagari Marathi',serif; font-size:clamp(14px,2.2vw,19px); font-weight:600; color:rgba(255,255,255,0.93); max-width:620px; margin:0 auto 40px; line-height:1.7; text-shadow:0 2px 12px rgba(0,0,0,0.25); }
//         .hero-btns { display:flex; gap:14px; justify-content:center; flex-wrap:wrap; }
//         .hero-btn-primary { padding:14px 36px; border-radius:12px; border:none; background:#6b72b0; color:#fff; font-weight:700; font-size:15px; font-family:'DM Sans',sans-serif; cursor:pointer; transition:all .2s; box-shadow:0 4px 20px rgba(107,114,176,0.45); }
//         .hero-btn-primary:hover { background:#5a5f9a; transform:translateY(-2px); }
//         .hero-btn-outline { padding:14px 36px; border-radius:12px; border:2px solid rgba(184,187,220,0.85); background:transparent; color:#b8bbdc; font-weight:700; font-size:15px; font-family:'DM Sans',sans-serif; cursor:pointer; transition:all .2s; }
//         .hero-btn-outline:hover { background:rgba(144,149,196,0.15); transform:translateY(-2px); }

//         /* ══ HOW IT WORKS ══ */
//         .hiw-section { padding:72px 24px 80px; background:#ffffff; position:relative; }
//         .hiw-section::before { content:''; position:absolute; inset:0; background-image:radial-gradient(circle at 15% 50%,rgba(144,149,196,0.07) 0%,transparent 55%),radial-gradient(circle at 85% 20%,rgba(107,114,176,0.06) 0%,transparent 50%); pointer-events:none; }
//         .hiw-inner { max-width:1080px; margin:0 auto; position:relative; z-index:1; }
//         .hiw-header { text-align:center; margin-bottom:52px; }
//         .hiw-title { font-family:'Crimson Pro',serif; font-size:clamp(28px,4.5vw,44px); font-weight:800; color:#1a1a1a; margin-bottom:12px; line-height:1.2; }
//         .hiw-title-bar { width:64px; height:4px; background:linear-gradient(90deg,#9095C4,#b8bbdc); border-radius:2px; margin:0 auto 14px; }
//         .hiw-sub { font-family:'DM Sans',sans-serif; color:#6b7280; font-size:15px; }
//         .hiw-grid { display:grid; grid-template-columns:repeat(4,1fr); gap:24px; align-items:stretch; }
//         .hiw-grid-wrap { position:relative; }
//         .hiw-connector { position:absolute; top:52px; left:calc(12.5% + 20px); right:calc(12.5% + 20px); height:2px; background:linear-gradient(90deg,rgba(144,149,196,0.3),rgba(144,149,196,0.6),rgba(144,149,196,0.3)); z-index:0; pointer-events:none; }
//         .hiw-card { background:#ffffff; border-radius:20px; padding:36px 22px 28px; text-align:center; border:1.5px solid rgba(144,149,196,0.18); box-shadow:0 4px 24px rgba(144,149,196,0.10),0 1px 4px rgba(0,0,0,0.04); transition:transform .25s,box-shadow .25s,border-color .25s; position:relative; z-index:1; display:flex; flex-direction:column; align-items:center; }
//         .hiw-card::before { content:''; position:absolute; top:0; left:0; right:0; height:4px; background:linear-gradient(90deg,#9095C4,#6b72b0); border-radius:20px 20px 0 0; }
//         .hiw-card:hover { transform:translateY(-8px); box-shadow:0 16px 40px rgba(144,149,196,0.22),0 4px 12px rgba(0,0,0,0.06); border-color:rgba(144,149,196,0.4); }
//         .hiw-icon-wrap { width:72px; height:72px; border-radius:50%; background:linear-gradient(135deg,#9095C4,#6b72b0); display:flex; align-items:center; justify-content:center; margin:0 auto 20px; box-shadow:0 6px 20px rgba(144,149,196,0.35); flex-shrink:0; }
...
//         .hiw-step-title { font-family:'DM Sans',sans-serif; font-weight:700; color:#272b5e; font-size:15px; margin-bottom:10px; line-height:1.3; }
//         .hiw-step-desc { font-family:'DM Sans',sans-serif; font-size:13px; color:#6b7280; line-height:1.65; flex:1; }
...
//         .mayor-heading-line1 { font-family:'Tiro Devanagari Marathi',serif; font-size:clamp(32px,4.2vw,56px); font-weight:800; color:#272b5e; line-height:1.15; margin:0 0 2px 0; position:relative; z-index:1; }
...
//         .mayor-btn-primary { display:inline-flex; align-items:center; gap:8px; padding:13px 28px; border-radius:8px; border:none; background:#6b72b0; color:#fff; font-weight:700; font-size:14px; font-family:'DM Sans',sans-serif; cursor:pointer; transition:all .2s; box-shadow:0 4px 16px rgba(107,114,176,0.35); width:fit-content; position:relative; z-index:1; }
//         .mayor-btn-primary:hover { background:#5a5f9a; transform:translateY(-2px); box-shadow:0 8px 22px rgba(107,114,176,0.45); }
...
//         .mayor-gold-tri { position:absolute; bottom:0; right:0; pointer-events:none; z-index:2; }
//         .mayor-sparkle { position:absolute; bottom:12%; right:2%; pointer-events:none; z-index:3; }
//         .mayor-phone-glow { position:absolute; top:50%; left:50%; transform:translate(-50%,-50%); width:320px; height:320px; border-radius:50%; background:radial-gradient(circle,rgba(144,149,196,0.18) 0%,transparent 65%); pointer-events:none; z-index:1; }
...
//         /* ══ PROJECTS ══ */
//         .projects-section { padding:80px 32px; background:linear-gradient(160deg,#eeeef8 0%,#FFFCF2 50%,#fff 100%); position:relative; overflow:hidden; }
...
//         .projects-inner { max-width:1060px; margin:0 auto; position:relative; z-index:1; }
//         .section-header { text-align:center; margin-bottom:48px; }
//         .section-tag { display:inline-block; background:linear-gradient(135deg,rgba(144,149,196,0.15),rgba(202,157,40,0.12)); color:#4a4f8a; font-size:12px; font-weight:700; padding:6px 18px; border-radius:999px; margin-bottom:14px; letter-spacing:0.6px; text-transform:uppercase; border:1px solid rgba(144,149,196,0.3); }
//         .section-title { font-family:'Crimson Pro',serif; font-size:clamp(28px,4vw,42px); font-weight:800; color:#272b5e; margin-bottom:8px; text-shadow:0 2px 8px rgba(0,0,0,0.06); }
//         .section-sub { color:#6b7280; font-size:15px; }

//         /* ── CARD ── */
//         .proj-card { display:flex; border-radius:28px; overflow:hidden; box-shadow:0 4px 0 0 rgba(144,149,196,0.35),0 16px 56px rgba(0,0,0,0.10),0 4px 16px rgba(0,0,0,0.06); min-height:320px; transition:box-shadow .35s,transform .35s; background:#fff; border:1.5px solid rgba(144,149,196,0.18); }
//         .proj-card:hover { transform:translateY(-6px); box-shadow:0 4px 0 0 rgba(144,149,196,0.5),0 28px 72px rgba(0,0,0,0.14),0 8px 24px rgba(0,0,0,0.08); }
//         .proj-left { flex:1; padding:44px 48px; display:flex; flex-direction:column; justify-content:center; border-radius:28px 0 0 28px; background-size:cover; background-position:top; background-repeat:no-repeat; }
//         .proj-tag { display:inline-flex; align-items:center; gap:6px; font-size:11px; font-weight:700; padding:5px 16px; border-radius:999px; text-transform:uppercase; letter-spacing:0.6px; margin-bottom:16px; width:fit-content; box-shadow:0 2px 8px rgba(0,0,0,0.08); }
//         .proj-title { font-family:'Tiro Devanagari Marathi',serif; font-size:clamp(18px,2.4vw,26px); font-weight:800; color:#1a1a1a; margin-bottom:14px; line-height:1.35; }
//         .proj-desc { font-family:'Tiro Devanagari Marathi',serif; font-size:13.5px; color:#555; line-height:1.85; margin-bottom:24px; max-width:480px; }
//         .proj-progress-row { display:flex; justify-content:space-between; margin-bottom:8px; }
//         .proj-progress-lbl { font-size:12px; font-weight:700; color:#4b5563; letter-spacing:0.3px; }
//         .proj-progress-pct { font-size:13px; font-weight:800; }
//         .proj-bar { height:12px; background:rgba(0,0,0,0.06); border-radius:999px; overflow:hidden; margin-bottom:22px; box-shadow:inset 0 2px 4px rgba(0,0,0,0.08); }
//         .proj-bar-fill { height:100%; border-radius:999px; transition:width 0.7s cubic-bezier(0.22,1,0.36,1); box-shadow:0 2px 8px rgba(0,0,0,0.2); position:relative; }
//         .proj-bar-fill::after { content:''; position:absolute; inset:0; background:linear-gradient(90deg,transparent 0%,rgba(255,255,255,0.35) 50%,transparent 100%); background-size:200% 100%; animation:barShimmer 2s ease-in-out infinite; border-radius:999px; }
//         @keyframes barShimmer { 0%{background-position:-200% 0} 100%{background-position:200% 0} }
//         .proj-meta { display:flex; align-items:center; gap:12px; flex-wrap:wrap; }
//         .proj-meta-item { font-size:12.5px; color:#6b7280; display:flex; align-items:center; gap:5px; background:rgba(0,0,0,0.04); padding:4px 10px; border-radius:8px; border:1px solid rgba(0,0,0,0.06); }
//         .proj-meta-item strong { color:#1a1a1a; }
//         .proj-chip { font-size:11px; font-weight:700; padding:5px 14px; border-radius:999px; text-transform:uppercase; letter-spacing:0.4px; }
//         .chip-ongoing { background:rgba(144,149,196,0.15); color:#3d4280; border:1px solid rgba(144,149,196,0.3); }
//         .chip-planning { background:rgba(202,157,40,0.15); color:#8a6010; border:1px solid rgba(202,157,40,0.3); }

//         /* ── RIGHT PANEL ── */
//         .proj-right { width:230px; flex-shrink:0; display:flex; flex-direction:column; align-items:center; justify-content:center; gap:16px; padding:36px 20px; border-radius:0 28px 28px 0; transition:background 0.5s; position:relative; overflow:hidden; }
//         .proj-right::before { content:''; position:absolute; inset:0; background:repeating-linear-gradient(-45deg,rgba(255,255,255,0.06) 0px,rgba(255,255,255,0.06) 1px,transparent 1px,transparent 18px); pointer-events:none; }
//         .proj-right::after { content:'✦'; position:absolute; top:16px; right:18px; font-size:18px; color:rgba(255,255,255,0.35); pointer-events:none; }
//         .proj-icon { font-size:68px; line-height:1; filter:drop-shadow(0 6px 16px rgba(0,0,0,0.2)); animation:iconFloat 3s ease-in-out infinite; }
//         @keyframes iconFloat { 0%,100%{transform:translateY(0)} 50%{transform:translateY(-8px)} }
//         .proj-stat-num { font-family:'Crimson Pro',serif; font-size:40px; font-weight:800; color:#fff; text-align:center; line-height:1; text-shadow:0 2px 12px rgba(0,0,0,0.2); }
//         .proj-stat-lbl { font-size:11px; color:rgba(255,255,255,0.88); font-weight:700; text-transform:uppercase; letter-spacing:0.5px; text-align:center; line-height:1.5; }

//         /* ── NAV ── */
//         .proj-nav { display:flex; align-items:center; justify-content:center; gap:14px; margin-top:32px; }
//         .proj-btn { width:44px; height:44px; border-radius:50%; border:1.5px solid rgba(144,149,196,0.35); background:rgba(255,255,255,0.9); color:#3d4280; font-size:20px; cursor:pointer; display:flex; align-items:center; justify-content:center; transition:all .2s; box-shadow:0 2px 12px rgba(144,149,196,0.15); backdrop-filter:blur(4px); }
//         .proj-btn:hover { background:linear-gradient(135deg,#9095C4,#3d4280); color:#fff; border-color:transparent; transform:scale(1.1); box-shadow:0 6px 20px rgba(144,149,196,0.35); }
//         .proj-dots { display:flex; gap:7px; align-items:center; }
//         .proj-dot { width:9px; height:9px; border-radius:50%; background:rgba(144,149,196,0.25); border:none; cursor:pointer; padding:0; transition:all .3s; }
//         .proj-dot.active { background:linear-gradient(135deg,#9095C4,#CA9D28); width:28px; border-radius:5px; box-shadow:0 2px 8px rgba(144,149,196,0.4); }
//         .proj-counter { font-size:12px; font-weight:700; color:#3d4280; font-family:'DM Sans',sans-serif; background:rgba(144,149,196,0.1); padding:3px 10px; border-radius:20px; border:1px solid rgba(144,149,196,0.2); }
...
//           .mayor-data-col{width:90px}
//           .proj-card{flex-direction:column}
//           .proj-left{border-radius:24px 24px 0 0;border-right:1px solid rgba(144,149,196,0.12);border-bottom:none;padding:28px 24px}
//           .proj-right{width:100%;border-radius:0 0 24px 24px;flex-direction:row;justify-content:center;gap:24px;padding:20px 24px}
//           .notice{margin:24px 16px}
//         }
//         @media(max-width:480px){
...
//         .news-section { background:#F4E7BE; padding:72px 32px 80px; position:relative; overflow:hidden; }
//         .news-section::before { content:''; position:absolute; inset:0; background:radial-gradient(circle at 15% 60%,rgba(144,149,196,0.08) 0%,transparent 50%),radial-gradient(circle at 85% 20%,rgba(107,114,176,0.07) 0%,transparent 50%); pointer-events:none; }
//         .news-inner { max-width:1060px; margin:0 auto; position:relative; z-index:1; }
//         .news-header { text-align:center; margin-bottom:48px; }
//         .news-section-tag { display:inline-block; background:rgba(202,157,40,0.15); color:#8a6010; font-size:12px; font-weight:700; padding:5px 16px; border-radius:999px; margin-bottom:14px; letter-spacing:0.6px; text-transform:uppercase; }
//         .news-title { font-family:'Crimson Pro',serif; font-size:clamp(28px,4vw,40px); font-weight:800; color:#1a3a2a; margin-bottom:8px; }
//         .news-title-bar { width:64px; height:4px; background:linear-gradient(90deg,#9095C4,#b8bbdc); border-radius:2px; margin:0 auto 10px; }
//         .news-sub { color:#7a6535; font-size:15px; }
//         .news-viewport { overflow-x:scroll; scrollbar-width:none; -ms-overflow-style:none; }
//         .news-viewport::-webkit-scrollbar { display:none; }
//         .news-track { display:flex; gap:20px; }
...
//         .news-card:hover .nc-arrow { background:#fff; transform:translateX(3px); }
//         .news-nav { display:flex; align-items:center; justify-content:center; gap:14px; margin-top:32px; }
//         .news-btn { width:42px; height:42px; border-radius:50%; border:1.5px solid rgba(144,149,196,0.3); background:rgba(255,255,255,0.7); color:#3d4280; font-size:20px; cursor:pointer; display:flex; align-items:center; justify-content:center; transition:all .2s; box-shadow:0 2px 8px rgba(0,0,0,0.06); backdrop-filter:blur(4px); }
//         .news-btn:hover { border-color:#9095C4; color:#9095C4; background:rgba(255,255,255,0.95); }
//         .news-dots { display:flex; gap:7px; align-items:center; }
//         .news-dot { width:9px; height:9px; border-radius:50%; background:rgba(144,149,196,0.25); border:none; cursor:pointer; padding:0; transition:all .25s; }
//         .news-dot.active { background:#9095C4; width:26px; border-radius:5px; }
//         .news-counter { font-size:12px; font-weight:600; color:#9ca3af; font-family:'DM Sans',sans-serif; }
...
//         {/* ══ PROJECTS CAROUSEL ══ */}
//         {/* <div className="projects-section" style={{backgroundColor:"#F9F9FD"}}>
//           <div className="projects-inner">
//             <div className="section-header">
//               <div className="section-tag">✦ सध्या सुरू</div>
//               <h2 className="section-title">चालू प्रकल्प</h2>
...
//               <div className="proj-left" style={{
//                 background: 'transparent',
//                 border: p.bgimg ? 'none' : '1px solid rgba(144,149,196,0.12)',
//                 borderRight: 'none'
//               }}>
//                 <div className="proj-tag" style={{ background: `${p.accent}18`, color: p.accent }}>{p.icon} {p.tag}</div>
//                 <div className="proj-title">{p.title}</div>
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        .hero::before { content:''; position:absolute; inset:0; background-image:url(${heroBg}); background-size:cover; background-position:left; background-repeat:no-repeat; z-index:0; }
        // .hero::after { content:''; position:absolute; inset:0; background:rgba(40,120,120,0.72); z-index:1; }
        .hero::after { content:''; position:absolute; inset:0; background:rgba(84,89,149,0.72); z-index:1; }
        .hero > * { position:relative; z-index:2; }
        .hero-orbit { position:absolute; inset:0; z-index:2; pointer-events:none; }
        .hero-float { position:absolute; background:rgba(208,154,80,0.92); border-radius:50%; display:flex; align-items:center; justify-content:center; font-size:18px; box-shadow:0 4px 20px rgba(0,0,0,0.25); animation:floatBob 3s ease-in-out infinite; }
        .hero-float.f1{width:52px;height:52px;top:28%;left:8%;animation-delay:0s} 
